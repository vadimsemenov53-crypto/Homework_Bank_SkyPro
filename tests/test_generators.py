...
@pytest.mark.parametrize(
    "transactions_info, currency, expected",
    [
        (
            [
                {"operationAmount": {"currency": {"code": "EUR"}}, "description": "Перевод организации"},
                {"operationAmount": {"currency": {"code": "USD"}}, "description": "Перевод с карты на карту"},
                {"operationAmount": {"currency": {"code": "EUR"}}, "description": "Анонимный перевод"},
            ],
            "EUR",
...
def test_filter_by_currency_case_sensitive():
    result = list(filter_by_currency([{"operationAmount": {"currency": {"code": "RUB"}}}], "rub"))
...
@pytest.mark.parametrize(
    "transactions_info, expected",
    [
        (
            [
                {"operationAmount": {"currency": {"code": "RUB"}}, "description": "Перевод организации"},
                {"operationAmount": {"currency": {"code": "USD"}}, "description": "Перевод с карты на карту"},
                {"operationAmount": {"currency": {"code": "EUR"}}, "description": "Анонимный перевод"},
            ],
            "Перевод организации, Перевод с карты на карту, Анонимный перевод",
