...
@pytest.fixture()
def operations_for_re_collections():
    return [
        {
            "id": 441945886,
            "state": "EXECUTED",
...
@pytest.fixture()
def categories_for_re_collections():
    return ["Перевод организации", "Открытие вклада", "Перевод с карты на счет"]
